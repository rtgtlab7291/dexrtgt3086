"""Floor-collision humanoid retargeting example: penalize foot-ground penetration."""
...
MOTION = "motions/SFU/0005/0005_2FeetJump001_poses.npz"
GROUND_WEIGHT = 1000.0  # set to 0.0 to watch the feet dive through the floor on landing
...
def main():
    ...
    # --- retarget: caller owns the floor scene; its config weight enables the collision term ---
    config = dataclasses.replace(g1_cali, scene_collision_weight=GROUND_WEIGHT, scene_collision_margin=0.0)
